...
badgers_all <- readRDS("Data/vaccination_badgers_jittered_filtered.RDS") %>% 
...
int_pointsw <- readRDS("Data/Inla/int_points4_vacc.RDS")
...
# saveRDS(m4, file = "Outputs/badgers_vaccination_model/final_badger_vaccination_model.RDS")
# m4 <- readRDS("Outputs/badgers_vaccination_model/final_badger_vaccination_model.RDS")
...
# saveRDS(lp4, file = "Outputs/badgers_vaccination_model/vac_linear_predictor.RDS")
# lp4 <- readRDS("Outputs/badgers_vaccination_model/vac_linear_predictor.RDS")
### Response scale ####
...
# saveRDS(rp4, file = "Outputs/badgers_vaccination_model/vac_response_predictor.RDS")
# rp4 <- readRDS("Outputs/badgers_vaccination_model/vac_response_predictor.RDS")
### plot #### 
