...
matern2D_big <- inla.spde2.pcmatern(mesh,
                                    ...
                                    prior.sigma = c(0.1, 0.1)) #0.01 at p 0.1 works
...
# saveRDS(m4, file = "Outputs/badgers_culling_model/final_model.RDS")
# m4 <- readRDS("Outputs/badgers_culling_model/final_model.RDS")
...
# saveRDS(lp4, file = "Outputs/badgers_culling_model/linear_predictor.RDS")
# lp4 <- readRDS("Outputs/badgers_culling_model/linear_predictor.RDS")
### Response scale ####
...
# saveRDS(rp4, file = "Outputs/badgers_culling_model/response_predictor.RDS")
